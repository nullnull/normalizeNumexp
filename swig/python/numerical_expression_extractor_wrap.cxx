...
SWIGINTERN PyObject *_wrap_NumericalExpressionExtractor_extract_numerical_expression(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOO:NumericalExpressionExtractor_extract_numerical_expression",&obj0,&obj1,&obj2)) SWIG_fail;
  ...
  if (!SWIG_IsOK(res3)) {
    SWIG_exception_fail(SWIG_ArgError(res3), "in method '" "NumericalExpressionExtractor_extract_numerical_expression" "', argument " "3"" of type '" "std::vector< std::string,std::allocator< std::string > > &""'"); 
  }
  if (!argp3) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "NumericalExpressionExtractor_extract_numerical_expression" "', argument " "3"" of type '" "std::vector< std::string,std::allocator< std::string > > &""'"); 
  }
  arg3 = reinterpret_cast< std::vector< std::string,std::allocator< std::string > > * >(argp3);
  (arg1)->extract_numerical_expression((std::string const &)*arg2,*arg3);
  resultobj = SWIG_Py_Void();
  if (SWIG_IsNewObj(res2)) delete arg2;
  return resultobj;
fail:
